...
function documentosCargados(executionContext) {
  try {
    ...
    setTimeout(() => {
      ...
      console.log(tp1, tp2, tp3, tp4, tp5, tp6, tp7);
      ...
      if (
        ...
        tp6 >= 1 &&
        tp7 >= 1 &&
        (validate_send.getValue() === 0 || validate_send.getValue() === null)
      ) {
        console.log("enviamos la notificacion");

        let urlflujo =
          "https://prod-06.brazilsouth.logic.azure.com:443/workflows/31996b6eb7b9400ebfbeb38d54689c5b/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=R1zlR6HJsNihYFodTXgI76keC7D36YXON2_C_7suHSA";
