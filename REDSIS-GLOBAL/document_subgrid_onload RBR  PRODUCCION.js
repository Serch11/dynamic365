    ...
    try {
        ...
        setTimeout(() => {
            ...
            if ((tp1 >= 1 && tp2 >= 1 && tp3 >= 1 && tp4 >= 1) && (validate_send.getValue() === 0 || validate_send.getValue() === null)) {
                ...
                let urlflujo = "https://prod-07.brazilsouth.logic.azure.com:443/workflows/66087ec5fb414761a6ec7a5ea467148c/triggers/manual/paths/invoke?api-version=2016-06-01&sp=%2Ftriggers%2Fmanual%2Frun&sv=1.0&sig=tPFHi4MwQrcNlv_Nq-lvr3sSL8zIhBwVA6yx5iO-3F8"
