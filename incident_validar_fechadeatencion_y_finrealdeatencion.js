  ...
  if (ap_iniciorealdeatencion.getValue() && ap_finrealdeatencion.getValue()) {
    ...
    if (
      ...
      var alertStrings = {
        ...
        text: "La fecha final de atencion no puede ser menor  a la fecha inicial de atencion. se le colocara la fecha actual",
      };
      ...
      Xrm.Navigation.openAlertDialog(alertStrings, alertOptions).then(
        function success() {
          ...
          ap_finrealdeatencion.setValue(new Date());
        },
        function (error) {
