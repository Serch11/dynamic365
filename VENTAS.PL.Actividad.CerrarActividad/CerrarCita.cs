...
namespace VENTAS.PL.Actividad.CerrarActividad
{
    public class CerrarCita : IPlugin
    {
        ...
        public void Run(IOrganizationService service, Entity entity, ITracingService seguimiento)
        {
            ...
            string pluginName = "VENTAS.PL.Actividad.CerrarActividad";
            ...
            try
            {
                ...
                if (entity.Contains("scheduledend"))
                {
                    ...
                    if(fechaFin < fechaActual)
                    {
                        ...
                        updateAct.Attributes.Add("actualend", DateTime.Now.AddHours(-5));
